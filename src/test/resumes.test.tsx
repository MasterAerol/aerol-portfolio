...
describe('targeted HTML resumes', () => {
  for (const variant of ['software', 'operations'] as const) {
    ...
    it(`keeps ${variant} education, completed training and claims accurate`, () => {
      ...
      expect(document.body).not.toHaveTextContent(/Professional Experience|Employment History|Work Experience|OpenAI API|Docker|Resend|AWS|Kubernetes|Stripe|LinkedIn|Play Store|Launching Soon|public users|exam pass rate|Udemy|certificate number|commercial experience/i)
