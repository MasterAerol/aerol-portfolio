...
Project content exists once in `src/data/projects.ts`. The shared card renders that data, including optional native disclosure details. Empty link arrays never render dummy links.
